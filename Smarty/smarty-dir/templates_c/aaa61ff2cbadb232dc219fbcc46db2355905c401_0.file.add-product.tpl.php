<?php
/* Smarty version 3.1.39, created on 2021-06-28 20:08:22
  from 'C:\Users\david\public_html\ADC-Store\Smarty\smarty-dir\templates\add-product.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60da1016bd2320_41837660',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'aaa61ff2cbadb232dc219fbcc46db2355905c401' => 
    array (
      0 => 'C:\\Users\\david\\public_html\\ADC-Store\\Smarty\\smarty-dir\\templates\\add-product.tpl',
      1 => 1624903701,
      2 => 'file',
    ),
  ),
...
function content_60da1016bd2320_41837660 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                    ...
                                    <div class="col-xl-7">
                                        <form class="needs-validation add-product-form" novalidate="" name="upload" enctype="multipart/form-data" method="post" action="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
GestioneProdotti/aggiungiProdotto">
                                            <div class="form">
                                            ...
                                            <div class="offset-xl-3 offset-sm-4">
                                                <button type="submit" class="btn btn-primary" href="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
GestioneProdotti/recuperaAggiungiProdotto" onclick="Funzione1()">Aggiungi</button>
                                                <a href="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
GestioneProdotti/recuperaAggiungiProdotto" class="btn btn-light">Annulla</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
