...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60d05d07bd3712_78574627',
...
function content_60d05d07bd3712_78574627 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="container-fluid">
                <div class="card tab2-card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="MainControl.php" method="post">
                        ...
                        <div class="pull-right">
                            <input type="submit" value="INVIA" onclick="Funzione1()" class="btn btn-primary" </input>
                        </div>
                        </form>
                    </div>
                </div>
...
<!-- feather icon js-->
<?php echo '<script'; ?>
 src="../assets/js/icons/feather-icon/feather.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../assets/js/icons/feather-icon/feather-icon.js"><?php echo '</script'; ?>
>

<!-- Sidebar jquery-->
<?php echo '<script'; ?>
 src="../assets/js/sidebar-menu.js"><?php echo '</script'; ?>
>

<!--Datepicker jquery-->
<?php echo '<script'; ?>
 src="../assets/js/datepicker/datepicker.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../assets/js/datepicker/datepicker.en.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../assets/js/datepicker/datepicker.custom.js"><?php echo '</script'; ?>
>

<!--Customizer admin-->
<?php echo '<script'; ?>
 src="../assets/js/admin-customizer.js"><?php echo '</script'; ?>
>
...
<!--right sidebar js-->
<?php echo '<script'; ?>
 src="../assets/js/chat-menu.js"><?php echo '</script'; ?>
>

<!--script admin-->
<?php echo '<script'; ?>
 src="../assets/js/admin-script.js"><?php echo '</script'; ?>
>
