...
<head>
    ...
    <title>ADC Store - Chi siamo</title>
...
<body>
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="{$path}Smarty/smarty-dir/assets/images/about/about%20us.jpg"
                            class="img-fluid blur-up lazyload" alt=""></div>
                </div>
                <div class="col-sm-12">
                    <br>
                    <h2>ADC-Store - L'ABC della qualità</h2>
                    <p>ADC-Store è una catena di supermercati che opera in Italia da ed è ormai diventata sinonimo di qualità e cortesia.
                    </p>
                    <p>Investiamo molto nelle nostre strutture e nei nostri prodotti, per offrire sempre ai nostri clienti
                ...
                <div class="col-sm-12">
                    ...
                    <div class="slide-2 testimonial-slider no-arrow">
                        <div>
                            <div class="media">
                                <div class="text-center">
                                    <img src="{$path}Smarty/smarty-dir/assets/images/cannavacciulo.jpg" alt="#">
                                    <h5>Antonino Cannavacciulo</h5>
                                    <h6>Chef</h6>
                                </div>
                                <div class="media-body">
                                    <p>ADC-Store è il mio fornitore di fiducia. Con loro ho sempre tutto quello
                                    di cui ho bisogno per i miei piatti ed i clienti sono sempre soddisfatti della qualità
                                    degli ingredienti.</p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="media">
                                <div class="text-center">
                                    <img src="{$path}Smarty/smarty-dir/assets/images/ronaldo.jpg" alt="#">
                                    <h5>Cristiano Ronaldo</h5>
                                    <h6>Calciatore</h6>
                                </div>
                                <div class="media-body">
                                    <p>Da quando sono in Italia non ho trovato un posto migliore per fare la spesa.
                                    Gli alimenti sono sempre freschi e di qualità, perfetti per la dieta di uno sportivo.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="media">
                                <div class="text-center">
                                    <img src="{$path}Smarty/smarty-dir/assets/images/avtar.jpg" alt="#">
                                    <h5>Mark Jecno</h5>
                                    <h6>Designer</h6>
                                </div>
                                <div class="media-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        <div>
                            <div>
                                <img src="{$path}Smarty/smarty-dir/assets/images/team/angelo1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Angelo Casciani</h4>
                            <h6>Project Manager & Co-fondatore</h6>
                        </div>
                        <div>
                            <div>
                                <img src="{$path}Smarty/smarty-dir/assets/images/team/david1.jpeg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>David Di Marco</h4>
                            <h6>Product Manager & Co-fondatore</h6>
                        </div>
                        <div>
                            <div>
                                <img src="{$path}Smarty/smarty-dir/assets/images/team/chiara2.jpeg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Chiara Romano</h4>
                            <h6>CEo & Co-fondatore</h6>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- menu js-->
    <script type="text/javascript" src="{$path}Smarty/smarty-dir/assets/js/menu.js"></script>
    ...
    <!-- slick js-->
    <script type="text/javascript" src="{$path}Smarty/smarty-dir/assets/js/slick.js"></script>
