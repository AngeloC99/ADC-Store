...
<head>
    ...
    <title>ADC-Store - Errore Registrazione</title>
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Errore Registrazione</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="error-section">
                        <h2>Errore Registrazione</h2>
                        <h3>Attenzione! Non è stato possibile creare l'account perchè l'email fornita risulta già registrata.</h3>
