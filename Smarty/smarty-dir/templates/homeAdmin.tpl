        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-center">
                    <img src="{$path}Smarty/smarty-dir/assets/images/home-banner/pres.png" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center">
                    <img src="{$path}Smarty/smarty-dir/assets/images/home-banner/sup.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                    ...
                    <div class="col-md-4 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Hai il pieno controllo sui prodotti</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4>Comunica con i clienti</h4>
                                <p>Sempre a disposizione 24 x 7</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4>Gestisci i premi</h4>
                                <p>Aggiungi nuovi premi per i clienti</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="{$path}Smarty/smarty-dir/assets/images/pro3/1.jpg" alt=""
