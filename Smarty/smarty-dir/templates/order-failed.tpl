...
<head>
    ...
    <title>ADC-Store - Ordine fallito</title>
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ordine fallito</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="error-section">
                        <h1>OOOPS!</h1>
                        <h2>Ordine non riuscito!</h2>
                        <h3>Attenzione! Non abbiamo potuto processare il tuo ordine perchè abbiamo terminato uno dei prodotti richiesti!</h3>
