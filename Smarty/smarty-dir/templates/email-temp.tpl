...
<head>
    ...
    <title>ADC Store - Email Buono</title>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;">
        <thead>
            <tr>
                ...
                <p style="margin:0">CODICE BUONO: {$codice}  </p>
                <p style="font-size:23px; margin:0;">valore: {$valore} </p>
                <p style="font-size:23px; margin:0;">scadenza: {$scadenza} </p>
                <p style="font-size:15px; margin:0;" >{$messaggio} </p>
