...
<head>
    ...
    <title>ADC Store - Area Amministratore</title>
    ...
    <!-- Ico-font-->
    <link rel="stylesheet" type="text/css" href="{$path}Smarty/smarty-dir/assets/css/icofont.css">

    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{$path}Smarty/smarty-dir/assets/css/flag-icon.css">

    <!-- Datepicker css-->
    <link rel="stylesheet" type="text/css" href="{$path}Smarty/smarty-dir/assets/css/date-picker.css">
    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none">
                <div class="logo-wrapper"><a href="index.html"><img class="blur-up lazyloaded" src="{$path}Smarty/smarty-dir/assets/images/dashboard/multikart-logo.png" alt=""></a></div>
            </div>
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li><a href="add-product.tpl"><i class="fa fa-circle"></i>Add Product</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-circle"></i>
...
<!--Datepicker jquery-->
<script src="{$path}Smarty/smarty-dir/assets/js/datepicker/datepicker.js"></script>
<script src="{$path}Smarty/smarty-dir/assets/js/datepicker/datepicker.en.js"></script>
<script src="{$path}Smarty/smarty-dir/assets/js/datepicker/datepicker.custom.js"></script>
