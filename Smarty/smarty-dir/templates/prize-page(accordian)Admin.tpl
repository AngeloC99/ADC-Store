...
<body>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="product-slick">
                            <div><img src="data:{$mime};base64,{$dati}"
                            class="flex" alt=""
    ...
    <script>
        ...
        function Aggiungi(){
            ...
            document.dati.action = "{$path}GestionePunti/aggiornaQuantitaPremio";
