...
<head>
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{$path}Smarty/smarty-dir/assets/css/themify.css">
...
<g>
    ...
    <path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method="post" action="{$path}GestioneUtenti/loginAdmin">
            ...
            <a href="{$path}GestioneSchermate/showHome" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>Torna alla Home</a>
        </div>
    </div>
</div>
...
<script src="{$path}Smarty/smarty-dir/assets/js/jsgrid/griddata-invoice.js"></script>
<script src="{$path}Smarty/smarty-dir/assets/js/jsgrid/jsgrid-invoice.js"></script>
